...
#comment[Compared to the previous formulation, now the delays are no longer an invention, but part of the direct formulation, which is much more elegant.]
...
#comment[This formulation seems more elegant!]
