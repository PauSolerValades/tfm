...
The fitting reuses the 7-candidate battery of @sec-cal-dist (MLE fits, closed-form KS/CvM/AD statistics, AIC selection). The population is the $2.12 times 10^6$ users with at least one session (see @sec-cal-sessions). Among them, $936{,}430$ users have at least two post creations and therefore produce gaps ---$N$ posts yield $N-1$ consecutive gaps--- and applying the same $n_"obs" >= 30$ criterion as @sec-cal-dist, the global quantity is fitted on the $176,217$ users with at least 30 gaps. The measurement produces $25.2 times 10^6$ global gaps (966k exact same-μs post duplicates dropped). @tbl-cal-interpost-family reports the AIC-best family composition of the global quantity.
#figure(
  table(
    columns: 8,
    ...
    [], table.vline(stroke: 0.5pt), [*Lognorm*], [*Power-law*], [*Weibull*], [*Gamma*], [*Exp*], [*Total*],
    table.hline(stroke: 0.5pt),
    [*Users*], [78,998], [60,761], [36,232], [222], [4], [*176,217*],
    [*%*], [44.8%], [34.5%], [20.6%], [0.13%], [0.00%], [*100%*],
    table.hline(stroke: 0.8pt),
  ),
