...
pub const SimConfig = struct {
    ...
    user_policy: DiscDist(Precision, Action),   // probability of available actions of the user
    ...
    session_duration: ConstDist(f64),           // which proportion of the users start on vacation
    user_inter_session: ConstDist(f64),         // duration of the current session
    // notification stuff
